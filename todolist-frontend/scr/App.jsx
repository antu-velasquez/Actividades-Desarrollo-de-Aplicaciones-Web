...
function App() {
  ...
  const handleGuardar = async (e) => {
    ...
    const payload = vista === 'tareas' 
      ? { task: inputData.nombre, description: inputData.descripcion, dueDate: inputData.fecha } 
      : { goal: inputData.nombre, description: inputData.descripcion, dueDate: inputData.fecha };
    ...
    try {
      ...
      setSuccess(`Status 200: ${vista === 'tareas' ? 'Tarea' : 'Meta'} guardada en base de datos`);
      setTimeout(() => {
        obtenerDatos();
  ...
  const handleEliminar = async (id) => {
    ...
    try {
      ...
      setSuccess(`Status 200: ${vista === 'tareas' ? 'Tarea' : 'Meta'} eliminada de la base de datos`);
      obtenerDatos();
